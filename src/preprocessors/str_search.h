...
typedef int (*MatchFunction)(void *, void *, int, void *);
#else
...
int  SearchFindString(unsigned int mpse_id, const char *str, unsigned int str_len, int confine,
#ifdef DETECTION_OPTION_TREE
int (*Match) (void *, void *, int, void *)
#else
...
int    SearchInstanceFindString( void * instance, const char *str, unsigned int str_len, int confine,
#ifdef DETECTION_OPTION_TREE
int (*Match) (void *, void *, int, void *)
#else
int (*Match) (void *, int, void *)
